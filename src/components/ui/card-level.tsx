    ...
    return (
        <div
            ...
            className={`
                ...
                ${active
                    ? "bg-[var(--color-parchment-50)] cursor-pointer shadow-[0px_2px_12px_rgba(15,15,15,0.1),inset_0px_-6px_0px_1px_var(--color-parchment-base)] active:scale-95"
        ...
        >
            ...
            <div className="flex flex-col items-center gap-[8px] w-full text-center">
                ...
                {active ? (
                    ...
                    <p className="text-b2-extrabold text-text-sub drop-shadow-sm px-2">
                        {unlockMessage}
                    </p>
                )}
            </div>
